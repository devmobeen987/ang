...
import {
  incomesingallistApi,
  incomesingallistApisecond,
} from 'src/app/model/income.model';
...
export class EditIncomeComponent implements OnInit {
  ...
  clientApi() {
    this.api
      .viewClientlist()
      .pipe(takeUntil(this.ngUnsubscribe))
      .subscribe((data: clientlistApireq) => {
  ...
  loadesingalclientapi() {
    this.api
      .viewsingalincome(this.id)
      .pipe(takeUntil(this.ngUnsubscribe))
      .subscribe((val: incomesingallistApisecond) => {
        // console.log(val);
  ...
  update() {
    ...
    this.api
      .updateClientApi(this.id, this.edit_income_form.value)
      .pipe(takeUntil(this.ngUnsubscribe))
      .subscribe(
        (data: any) => {
          console.log(data);
